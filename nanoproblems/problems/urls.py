...
urlpatterns = [
    ...
    url(r'^(?P<problem_id>[0-9]+)/comments/all/$', views.problem_comments_as_json, name='problem_comments_as_json'),
    url(r'^(?P<problem_id>[0-9]+)/comments/new/$', views.new_comment_problem, name='new_comment_problem'),
    ...
    url(r'^(?P<problem_id>[0-9]+)/comments/(?P<comment_id>[0-9]+)/delete/$', views.delete_comment_from_problem, name='delete_comment_from_problem'),
    ...
    url(r'^(?P<problem_id>[0-9]+)/show_solution/(?P<solution_id>[0-9]+)/comments/(?P<comment_id>[0-9]+)/delete/$', views.delete_comment_from_solution, name='delete_comment_from_solution'),
    ...
    url(r'^(?P<problem_id>[0-9]+)/show_solution/(?P<solution_id>[0-9]+)/comments/all/$', views.solution_comments_as_json, name='comments_as_json'),
    url(r'^(?P<problem_id>[0-9]+)/show_solution/(?P<solution_id>[0-9]+)/comments/new/$', views.new_comment_solution, name='new_comment_solution'),
    ...
    url(r'solutions_json/all$', views.solutions_json, name='solutions_json'),
